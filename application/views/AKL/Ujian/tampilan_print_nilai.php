    ...
    <div class="container">
        <div class="row" style="margin-top: 50px;">
            ...
            <div class="col-md mt-4">
                ...
                <h5>Jadwal Akhir : <?= $header['jam_akhir'] ?>:<?= $header['menit_akhir'] ?> - <?= $header['hari_akhir']; ?>, <?= $header['tanggal_awal']; ?> <?= $header['bulan_awal']; ?> <?= $header['tahun_awal']; ?></h5>
                <h5>Sekolah : SMK Tunas Harapan</h5>
            </div>
        </div><br>
